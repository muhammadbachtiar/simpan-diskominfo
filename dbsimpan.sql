...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2023 at 08:49 AM
...
INSERT INTO `berkas` (`id`, `nama`, `kategori_berkas_id`, `path`, `created_at`, `updated_at`) VALUES
(1, 'Peraturan Bupati Muara Enim Nomor 52 Tahun 2022 tentang Penyelenggaraan Sistem Pemerintahan Berbasis Elektronik', 1, 'MzESc93HYcHCH4y2ZxKFce2ApvznSD-metaQS5wZGY=-.pdf', '2023-07-10 05:50:38', '2023-07-10 05:56:25'),
(2, 'Peraturan Bupati Muara Enim Nomor 53 Tahun 2022 tentang Rencana Induk Sistem Pemerintahan Berbasis Elektronik', 1, 'lWp018L4g1ovdANP01EB92i5wG2Euk-metaQi5wZGY=-.pdf', '2023-07-10 05:54:09', '2023-07-10 05:56:38'),
(3, 'Surat Keputusan Bupati Muara Enim Nomor 65 Tahun 2023 tentang Tim Koordinasi SPBE Pemerintah Kabupaten Muara Enim Tahun 2023', 1, 'dmWEfO7xihtVFICSsUfaCh8Wrz29TT-metaU0sgVElNIEtPT1JESU5BU0kgU1BCRSAyMDIzLnBkZg==-.pdf', '2023-07-10 05:56:12', '2023-07-10 05:57:12'),
(4, 'Surat Keputusan Bupati Muara Enim Nomor 66 Tahun 2023 tentang Tim Asesor Internal SPBE Lingkup Kabupaten Muara Enim Tahun 2023', 1, 'jYCSW6ckNjvZlJ6Lt335u9UJljXgWf-metaU0sgVElNIEFTRVNPUiBJTlRFUk5BTCBTUEJFIDIwMjMucGRm-.pdf', '2023-07-10 05:59:17', '2023-07-10 05:59:17'),
(5, 'SOP Akses Ruang Data Center Pemkab Muara Enim', 1, 'pUqeF6UJ2B9U3ePOdVZJlCPz4oCkDl-metaU09QIEFrc2VzIHJ1YW5nIGRhdGEgY2VudGVyIHBlbWthYl8wMDEucGRm-.pdf', '2023-07-10 09:00:54', '2023-07-10 09:00:54'),
(6, 'SOP Monitoring dan evaluasi SPBE', 1, 'THcFu0ogxacqaCavCIY5z1VGixDiNJ-metaU09QIE1vbml0b3JpbmcgZGFuIGV2YWx1YXNpIFNQQkVfMDAxLnBkZg==-.pdf', '2023-07-10 09:01:23', '2023-07-10 09:01:23'),
(7, 'SOP Pemeliharaan Komponen Jaringan', 1, 'JOvmBywf4s5ZJS33ci83upiZJHra2X-metaU09QIFBlbWVsaWhhcmFhbiBrb21wb25lbiBqYXJpbmdhbl8wMDEucGRm-.pdf', '2023-07-10 09:01:45', '2023-07-10 09:01:45'),
(8, 'SOP Penyusunan Arsitektur SPBE', 1, 'Ldr2SkaoGAPyDpBPMNRtwDmtawFrO8-metaU09QIFBlbnl1c3VuYW4gQXJzaXRla3R1ciBTUEJFXzAwMS5wZGY=-.pdf', '2023-07-10 09:02:14', '2023-07-10 09:02:14'),
(9, 'SOP Penyusunan Kebijakan Teknis SPBE', 1, 'j96M2S3xuwLUq9huoMznUgR5m8JwKK-metaU09QIFBlbnl1c3VuYW4gS2ViaWpha2FuIFRla25pcyBTUEJFXzAwMS5wZGY=-.pdf', '2023-07-10 09:02:38', '2023-07-10 09:02:38'),
(10, 'SOP Tatalaksana Permohonan Penggunaan Subdomain dan Hosting', 1, 'ZN3lYw4P1rKbwRKtV3d385fULxbuy7-metaU09QIFRhdGFsYWtzYW5hIHBlbmdndW5hYW4gc3ViIGRvbWFpbi5wZGY=-.pdf', '2023-07-10 09:05:06', '2023-07-10 09:05:06'),
(11, 'SOP Pengembangan Aplikasi E-Government', 1, 'owW15R44X0Bh8ntbdREWgPdG8HVYj2-metaU09QIFBlbmdlbWJhbmdhbiBBcGxpa2FzaSBFLUdvdmVybm1lbnQucGRm-.pdf', '2023-07-10 09:56:29', '2023-07-10 09:56:29'),
(12, 'SOP Penambahan Infrastruktur Jaringan', 1, 'bnriMgsUu1E2FUp7EaRAaAIZxQ5GaB-metaU09QIFBFTkFNQkFIQU4gSU5GUkFTVFJVS1RVUiBKQVJJTkdBTi5wZGY=-.pdf', '2023-07-10 09:57:37', '2023-07-10 09:57:37');
...
(11, '2023_07_10_022900_create_kategori_berkas_table', 1);
...
CREATE TABLE `navigations` (
  ...
  `status_menu` varchar(100) DEFAULT 'tidak ada',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, NULL, 'Profil', '', 'profil', 'Ada', '2023-07-10 05:35:14', '2023-07-10 05:35:14'),
...
(7, NULL, 'Agenda', '', 'agenda', 'Ada', '2023-07-10 05:39:36', '2023-07-10 05:42:14'),
...
(9, NULL, 'Hasil Evaluasi', '', 'hasil-evaluasi', 'Ada', '2023-07-10 07:16:13', '2023-07-10 07:16:13'),
...
(1, 'superadmin', 'super@admin.com', NULL, '$2y$10$t0X6Ay7mN30eOrN.cEqT.u07mLeg5OG2Ryq.zs8Zh1AOIfZnR9Oq2', '', '2023-07-09 18:06:42', '2023-07-09 18:06:42');
